                    ...
                    <div class="card shadow ">
                        ...
                        <div class="card-body p-6">
                            <div class="mb-4">
                                ...
                                <span>I've now remembered my password <a href="<?php echo e(route('login')); ?>" class="ms-1">Take me back to the login</a></span>
                            </div>
                            <!-- Alert -->
                            ...
                            <!-- Form -->
                            <form method="POST" action="<?php echo e(route('password.forgot.post')); ?>">
                                <?php echo csrf_field(); ?>
                                <!-- Email -->
                                <div class="mb-3">
...
<?php /**PATH /var/www/html/resources/views/login/forgot_password.blade.php ENDPATH**/ ?>