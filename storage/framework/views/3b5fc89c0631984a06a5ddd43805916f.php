                            ...
                            <tr>
                                <td>
                                    <h1>Issued <strong><?php echo e($data['issue_key']); ?></strong> of Project
                                        <strong><?php echo e($data['project_key']); ?></strong> has not been implemented by
                                        <?php echo e($data['name'] ?? $data['email']); ?></h1>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                        ...
                                        <div class="flex-grow-1 flex-shrink-1">
                                            <div>
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <p class="mb-1">
                                                        <strong>Due date :</strong><span><?php echo e($data['due_date']); ?></span>
                                                    </p>
                                                </div>
                                                <p class="small mb-0">
                                                </p>
...
<?php echo $__env->make('mails.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/mails/issue-urge.blade.php ENDPATH**/ ?>