            ...
            <div class="container">
                <div class="content">
                    <table class="content-table">
                        <tr>
                            <td>
                                <h1><?php echo e($data['displayName']); ?> has left a comment</h1>
                            </td>
                        </tr>
                        <tr>
                            <td>
...
<?php echo $__env->make('mails.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/mails/create_comment.blade.php ENDPATH**/ ?>