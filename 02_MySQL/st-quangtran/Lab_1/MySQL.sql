...
-- ALTER ADD CONSTRANT
ALTER TABLE KHACHHANG ADD CONSTRAINT CHECK_DienThoai_Start_With_0 CHECK (DienThoai LIKE '0%');

-- ALTER DELETE CONSTRANT
ALTER TABLE KHACHHANG DROP CONSTRAINT CHECK_DienThoai_Start_With_0;
